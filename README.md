...
# Compilation
Sur windows, un simple make devrait suffire à partir du moment où [git bash](https://git-scm.com/download/win) et [mingw gcc](https://sourceforge.net/projects/mingw-w64/files/Toolchains%20targetting%20Win64/) sont installés. Les librairies utiles à la compilation sont incluses dans les sous répertoires. Git pour windows inclus une version de bash pour windows ainsi que la plupart des commandes Unix, c'et bien pratique pour unifier les commandes de compilation.
